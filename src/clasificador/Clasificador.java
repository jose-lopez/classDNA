    ...
    public ArrayList<Object> clasificador() throws Exception {
        ...
        switch (sitio) {
            ...
            case 2:
                ...
                if (seleccionAtributos) {
                    vectorAtributos = new int[]{15,28,31,32,33,34,36,41,45,50,51,52,53,63,64,68,72,73,92,112,139,140,143,149,171,181,214,220,222,229,238,262,273,278,295,298,300,325,342,356,362,367,368,386,406,410,430,496,538};
                }
